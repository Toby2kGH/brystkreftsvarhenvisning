          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  description: 'Abemaciclib vs Ribociclib (NBCG 04.09.25)',
                  icon: '🎯',
                  tableRef: 'cdk46',
                  children: [
                    { id: 'cdk-t1n0', label: 'T1 N0 (St. I)', leaf: true, tableRef: 'cdk46', ruleFilter: 'R1', description: 'Ingen CDK4/6i (lav risiko)', resultColor: 'negative' },
                    { id: 'cdk-n1mi', label: 'N1mi', leaf: true, tableRef: 'cdk46', ruleFilter: 'R_N1mi', description: 'Ingen CDK4/6i-indikasjon ved mikrometastase', resultColor: 'negative' },
                    { id: 'cdk-t2n0', label: 'T2 N0 (St. IIA)', leaf: true, tableRef: 'cdk46', ruleFilter: 'R2', description: 'Ribo kun ved G3/GES høy', resultColor: 'equivocal' },
                    { id: 'cdk-t1n1', label: 'T1 N1 (St. IIA)', leaf: true, tableRef: 'cdk46', ruleFilter: 'R3', description: 'Abema ved G3 (1.valg). Ribo ved G3/GES høy', resultColor: 'equivocal' },
                    { id: 'cdk-t2n1', label: 'T2 N1 (St. IIB)', leaf: true, tableRef: 'cdk46', ruleFilter: 'R4', description: 'Abema ved G3 (1.valg). Ribo ja (ikke G1/lavrisiko GES)' },
                    { id: 'cdk-t3n0', label: 'T3 N0 (St. IIB)', leaf: true, tableRef: 'cdk46', ruleFilter: 'R5', description: 'Ribo ja (ikke G1/lavrisiko GES). Abema nei' },
                    { id: 'cdk-t3n1', label: 'T3 N1', leaf: true, tableRef: 'cdk46', ruleFilter: 'R6b', description: 'Abemaciclib FØRSTEVALG + Ribo', resultColor: 'positive' },
                    ...
                    { id: 'cdk-t4n0', label: 'T4 N0', leaf: true, tableRef: 'cdk46', ruleFilter: 'R7', description: 'Ribo ja. Abema nei' },
                    { id: 'cdk-t4n1', label: 'T4 N1', leaf: true, tableRef: 'cdk46', ruleFilter: 'R7b', description: 'Ribo ja. Abema ved G3 eller ≥5cm' },
                  ],
                },
              ],
            },
